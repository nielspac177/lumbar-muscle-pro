  ...
  sections: [{
    ...
    children: [
      ...
      ...img("forest_mcid.png", 1.28,
        "Figure 3. Exploratory secondary analysis. Adjusted odds ratios (per 1 SD) for achieving MCID at one year, contrasting muscle size (spine-normalized volume) with quality (T2 heterogeneity) for each muscle across three instruments (Global Physical Health, ODI, PROMIS Physical Function). The iliopsoas heterogeneity association is significant for ODI MCID only and does not replicate on the other instruments; reference line at OR=1.", 560),
